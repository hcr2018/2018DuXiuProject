 ...
 */
@WebServlet("/UploadUtil")
public final class UploadUtil extends HttpServlet {
	 public void doGet(HttpServletRequest request, HttpServletResponse response)
	            throws ServletException, IOException {
	                ...
	                try{
	                    ...
	                    for(FileItem item : list){
	                        ...
	                        if(item.isFormField()){
	                            ...
	                            System.out.println("38383838"+savePath);
	                            ...
	                            while((len=in.read(buffer))>0){
	                        		...
	                        		System.out.println("111111111"+path);
	                        		// 要上传到hdfs的目标路径
	               ...
	               // request.setAttribute("savePath", message);
